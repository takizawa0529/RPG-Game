...
imgEnemy = pygame.image.load("./img/enemy4.png")
...
emy_blink = 0
dmg_eff = 0
COMMAND = ["[A]ttack", "[P]ortion", "[B]laze gem", "[R]un"]
...
def draw_battle(bg, fnt):
    ...
    for i in range(10):
        draw_text(bg, message[i], 600, 100+50*i, fnt, WHITE)
    ...
    while True:
        ...
        if idx == 10:
            ...
            if tmr == 5:
                ...
                set_message(f"{dmg}pts of damage!")
            if tmr == 16:
                idx = 13
                tmr = 0
            ...
            if tmr == 5:
                ...
                emy_step = 30
            if tmr == 9:
                emy_dmg = random.randint(1, 10)
                set_message(f"{emy_dmg}pts of damage!")
                dmg_eff = 5
                emy_step = 0
            if tmr == 20:
                idx = 11
